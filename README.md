# <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Hand%20gestures/Waving%20Hand.gif" width="30px" height="30px" /> Hi, I'm Chad Sisson

<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=5AE87C&center=true&vCenter=true&width=435&lines=Senior+Cybersecurity+Engineer;Security+Architect+%26+vCISO;10%2B+Years+Experience" alt="Typing SVG" />
</div>

## 🛡️ About Me

Senior Cybersecurity Engineer & Architect with a passion for building secure, scalable solutions. Currently serving as virtual CISO to 14+ organizations while managing security operations across 50+ client environments.

- 🔐 **Security Focus:** Incident Response, SIEM (Splunk, Blumira), EDR (SentinelOne), Security Automation
- 💼 **Current Role:** Senior Security Engineer & Architect at Huber & Associates
- 🎯 **Certifications:** CompTIA Security+ | Pursuing CISSP
- 🚀 **Automation:** Python, Java, Kotlin - Building tools that save 20+ analyst hours weekly
- 🎮 **Side Projects:** BehaviorGuard (Bot Detection), Cipherial (Security Training Platform)
...
- 📚 Developing **Cipherial** - Security awareness training platform for MSPs
- 🎓 Pursuing **CISSP** certification
- 💼 Actively exploring senior security roles at Fortune 500 companies
